...
// 	Legitbot::aimStepInProgress = ( fov > (Math::float_rand(Settings::Aimbot::AimStep::min, Settings::Aimbot::AimStep::max)) );
...
// 			return;
// 		}
// 		else if( (active_weapon->GetSpread() + active_weapon->GetInaccuracy()) == Settings::Aimbot::SpreadLimit::value ) {
// 			cmd->buttons |= IN_WALK;
// 			forward = 0;
// 			sideMove = 0;
// 			cmd->upmove = 0;
...
// 		//if (localplayer->GetVelocity().Length() > Settings::Aimbot::SpreadLimit::value )
// 	}
// 	else if( localplayer->GetVelocity().Length() > (activeWeapon->GetCSWpnData()->GetMaxPlayerSpeed() / 3.0f)) // https://youtu.be/ZgjYxBRuagA
// 	{
// 		cmd->buttons |= IN_WALK;
// 		forward = -forward;
// 		sideMove = -sideMove;
// 		cmd->upmove = 0;
// 	}
// 	else if (localplayer->GetVelocity().Length() < 1.0f) {
// 		cmd->buttons |= IN_RUN;
// 		forward = 0;
// 		sideMove = 0;
// 		cmd->upmove = 0;
...
//     if (Settings::Aimbot::AimStep::enabled && Legitbot::aimStepInProgress)
//         return;
